                        ...
                        <Table className='tableFixHead'>
                            <thead>
                                <tr>
                                    ...
                                    <th className=''>Export Sailing Date</th>
                                    <th className=''>ETA Date</th>
                                ...
                                {state.voyageList.map((x, i) => {
                                    return (
                                        ...
                                        >
                                            ...
                                            <td className='pt-1'>{x.importArrivalDate ? moment(x.importArrivalDate).format("DD-MM-YYYY") : '-'}</td>
                                            <td className='pt-1'>{x.importOriginSailDate ? moment(x.importOriginSailDate).format("DD-MM-YYYY") : '-'}</td>
                                            <td className='pt-1'>{x.exportSailDate ? moment(x.exportSailDate).format("DD-MM-YYYY") : '-'}</td>
                                            <td className='pt-1'>{x.destinationEta ? moment(x.destinationEta).format("DD-MM-YYYY") : '-'}</td>
                                            <td className='pt-1'>{x.cutOffDate ? moment(x.cutOffDate).format("DD-MM-YYYY") : '-'}</td>
                                            <td className='pt-1'>{x.cutOffTime ? moment(x.cutOffTime).format("DD-MM-YYYY") : '-'}</td>
                                        </tr>
                                    )
                                })}
                            </tbody>
